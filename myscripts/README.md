...
* [Вывод CSV-файлов](#Вывод-CSV-файлов)
  ...
  * [вывод CSV в таблицу-лесенку](#[csv2step.sh](csv2step.sh))
 ...
 * [форматирование строки "%Ns"](#форматирование-строки-"%Ns")
...
### [csv2table.sh](csv2table.sh): вывод CSV в форматированную таблицу
