...
### Форматирование строки "%Ns"

**[prntfUTF](prntfUTF.sh)** -- функция форматирует строку в поле с заданной минимальной длинной. Если строка меньше поля, то добпвляются пробелы справа или слева строки
